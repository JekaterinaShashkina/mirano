...
export const App = () => {
  ...
  return (
    ...
    <div class="container header__container">
      <form class="header__form" action="#">
        <input class="header__input" type="search" name="search"
          placeholder="Букет из роз"/>

        <button class="header__search-button" aria-label="начать поиск">
      ...
      <button class="header__cart-button">0</button>
    </div>
  </header>
  ...
  <main>
    <section class="hero">
      <div class="container">
        <div class="hero__head-group">
          <h1 class="hero__title">Авторские букеты</h1>
          <p class="hero__subtitle">и подарки</p>
        </div>

        <figure class="hero__group-image">
          <picture class="hero__image hero__image_left">
            <source
          ...
          <svg class="hero__image hero__image_center" role="img"
            ...
            <foreignobject clip-path="url(#hero)" width="100%" height="100%">
              <div class="hero__image-center"></div>
            </foreignobject>

          </svg>


          <picture class="hero__image hero__image_right">
            <source
      ...
      <div class="container">
        <form class="filter__form">
          <fieldset class="filter__group">
            <input class="filter__radio" type="radio" name="type"
              value="bouquets" id="flower" checked>
            <label class="filter__label filter__label_flower"
              for="flower">Цветы</label>

            <input class="filter__radio" type="radio" name="type" value="toys"
              id="toys">
            <label class="filter__label filter__label_toys"
              for="toys">Игрушки</label>

            <input class="filter__radio" type="radio" name="type"
              value="postcards" id="postcard">
            <label class="filter__label filter__label_postcard"
              for="postcard">Открытки</label>
          </fieldset>

          <fieldset class="filter__group filter__group_choices">
            <div class="filter__choices choices">
              <button class="filter__select choices__btn"
                type="button">Цена</button>

              <div class="choices__box filter__choices-box">
                <fieldset class="filter__price">
                  <input class="filter__input-price" type="text" name="minPrice"
                    placeholder="от">
                  <input class="filter__input-price" type="text" name="maxPrice"
                    placeholder="до">
                </fieldset>
              </div>
            </div>

            <div class="filter__choices filter__choices_type choices">
              <button class="filter__select choices__btn" type="button">Тип
                товара</button>

              <div
                class="choices__box filter__choices-box filter__choices-box_type">
                <ul class="filter__type-list">
                  <li class="filter__type-item">
                    <button class="filter__type-button"
                      type="button">Монобукеты</button>
                  </li>
                  <li class="filter__type-item">
                    <button class="filter__type-button" type="button">Авторские
                      букеты</button>
                  </li>
                  <li class="filter__type-item">
                    <button class="filter__type-button" type="button">Цветы в
                      коробке</button>
                  </li>
                  <li class="filter__type-item">
                    <button class="filter__type-button" type="button">Цветы в
                  ...
                  <li class="filter__type-item">
                    <button class="filter__type-button" type="button">Букеты из
                      сухоцветов</button>
                  </li>
                </ul>
              </div>
    ...
    <section class="goods">
      <div class="container goods__container">
        <div class="goods__box">
          <h2 class="goods__title">Цветы</h2>
          ...
          <ul class="goods__list">
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Букет из тюльпан Dolche vita (51 шт)
                  </h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">6700&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Букет из роз Grand Avalanche (101 шт)
                  </h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">14800&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Букет из роз Grand Vanilla Cream (101
                    шт)</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">19800&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Букет из роз Grand Mirabel (101 шт)
                  </h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">21300&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Букет 101 Эквадорская роза микс</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">14200&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Букет Mona Lisa (Дельфиниум)</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">13600&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Авторский букет из роз, диантусов и
                    сухоцветов</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">3000&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Авторский букет из роз, герберов,
                    диантусов и сухоцветов</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">2000&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Авторский букет из роз и сухоцветов
                  </h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">2200&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Монобукет из тюльпанов</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">1600&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Авторский букет из роз и диантусов
                  </h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">2700&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Монобукет из сухоцветов</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">1500&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Цветы в коробке с лилиями и орхидеями
                  </h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">3400&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Авторский букет из лилий и хризантем
                  </h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">2900&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Монобукет из пионов</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">2500&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Цветы в корзине с разноцветными
                    ранункулюсами</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">3800&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Букет из сухоцветов и лаванды</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">1700&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Цветы в коробке из гербер и ирисов
                  </h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">3200&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Цветы в корзине с миксом весенних
                    цветов</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">3600&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Монобукет из ромашек</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">1400&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Авторский букет из гладиолусов и
                    альстромерий</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">3100&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Букет из сухоцветов с эвкалиптом</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">2000&nbsp;₽</button>
                  </div>
            ...
            <li class="goods__item">
              ...
              <img class="card__image"
                ...
                <div class="card__content">
                  <h3 class="card__title">Цветы в коробке с суккулентами и
                    каллами</h3>
                  <div class="card__footer">
                    <p class="card__date-delivery">сегодня в 14:00</p><button
                      class="card__button">3700&nbsp;₽</button>
                  </div>
                </div>
              </article>
            </li>
        ...
        <section class="cart cart_open">
          <div class="cart__container">
            ...
            <p class="cart__date-delivery">сегодня в 14:00</p>

            <ul class="cart__list">
              <li class="cart__item"><img class="cart__img"
                  src="https://dull-rose-pawpaw.glitch.me/img/39.jpg"
                  alt="Букет из роз Grand Avalanche (101 шт)"/>
                <h4 class="cart__item-title">Букет из роз Grand Avalanche (101
                  шт)</h4>
                <div class="cart__counter"><button
                    class="cart__counter-btn">-</button><input
                    class="cart__counter-input" type="number" max="99" min="0"
                    value="1"><button class="cart__counter-btn"/>+</button></div>
                <p class="cart__price">14800&nbsp;₽</p>
              </li>
              <li class="cart__item"><img class="cart__img"
                  src="https://dull-rose-pawpaw.glitch.me/img/38.jpg"
                  alt="Букет из тюльпан Dolche vita (51 шт)"/>
                <h4 class="cart__item-title">Букет из тюльпан Dolche vita (51
                  шт)</h4>
                <div class="cart__counter"><button
                    class="cart__counter-btn">-</button><input
                    class="cart__counter-input" type="number" max="99" min="0"
                    value="2"><button class="cart__counter-btn"/>+</button></div>
                <p class="cart__price">13400&nbsp;₽</p>
              </li>
              <li class="cart__item"><img class="cart__img"
                  src="https://dull-rose-pawpaw.glitch.me/img/41.jpg"
                  alt="Букет из роз Grand Mirabel (101 шт)"/>
                <h4 class="cart__item-title">Букет из роз Grand Mirabel (101 шт)
                </h4>
                <div class="cart__counter"><button
                    class="cart__counter-btn">-</button><input
                    class="cart__counter-input" type="number" max="99" min="0"
                    value="3"><button class="cart__counter-btn"/>+</button></div>
                <p class="cart__price">63900&nbsp;₽</p>
              </li>
            </ul>

            <div class="cart__footer">
              <button class="cart__order-btn">Оформить</button>
              <p class="cart__price cart__price_total">0&nbsp;₽</p>
            </div>
          </div>
        </section>
  ...
  <footer class="footer">
    <div class="container footer__container">
      ...
      <address class="footer__address">
        ...
        <ul class="footer__social-list">
          <li class="footer__social-item">
            <a class="footer__link" href="#" aria-label="канал в телеграм">
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <li class="footer__social-item">
            <a class="footer__link" href="#" aria-label="канал в youtube">
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <li class="footer__social-item">
            <a class="footer__link" href="#" aria-label="группа в вк">
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
      ...
      <div class="footer__developers">
        <p class="footer__developers-title">Проект сделан в учебных целях</p>

        <ul class="footer__developers-list">
          <li class="footer__developers-item">
            Designer: <a class="footer__link" href="Anastasia_Ilina">Anastasia
              Ilina</a>
          </li>
          <li class="footer__developers-item">
            Developer: <a class="footer__link" href="maksim_leskin">Makism
              Leskin</a>
          </li>
        </ul>
      </div>

      <p class="footer__copyright">©MIRANO, 2024</p>
    </div>
  </footer>
    ...
    <div class="order__wrapper">
      ...
      <form class="order__form" id="order">
        <fieldset class="order__fieldset">
          ...
          <div class="order__input-group"><input class="order__input"
              type="text" name="name-buyer" placeholder="Имя"/><input
              class="order__input" type="text" name="phone-buyer"
        ...
        <fieldset class="order__fieldset">
          ...
          <div class="order__input-group"><input class="order__input"
              ...
              class="order__input" type="text" name="phone-recipient"
              placeholder="Телефон"/></div>
        </fieldset>
        <fieldset class="order__fieldset">
          ...
          <div class="order__input-group"><input class="order__input"
              ...
              class="order__input order__input_min" type="text" name="house"
              placeholder="Дом"/><input class="order__input order__input_min"
              type="text" name="apartment" placeholder="Квартира"/></div>
        </fieldset>
        <fieldset class="order__fieldset">
          <div class="order__payment"><label class="order__label-radio"><input
                class="order__radio" type="radio" name="payment-online"
                value="true" checked="true"/>Оплата онлайн</label></div>
          <div class="order__delivery"><label for="delivery">Доставка
              01.07</label><input type="hidden" name="delivery-date"
              value="01.07"/>
            <div class="order__select-wrapper"><select class="order__select"
      ...
      <div class="order__footer">
        <p class="order__total">92100&nbsp;₽</p><button class="order__button"
          type="submit" form="order">Заказать</button>
      </div>
    </div>
    <button class="order__close" type="button">×</button>
  </div>

  <div class="order">
    <div class="order__wrapper">
      <h2 class="order__title">Заказ оформлен!</h2>
      <p class="order__id">Ваш номер заказа:
